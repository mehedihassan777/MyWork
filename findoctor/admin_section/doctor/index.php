<?php
    ...
    session_start();
    if(!isset($_SESSION['name']))
    header("location:../../html_menu_1/login.php");
    }
?>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bookings">
          <a class="nav-link" href="bookings.php">
            ...
            <span class="nav-link-text">Bookings <span class="badge badge-pill badge-primary">New</span></span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Welcome <?php
                  if(!isset($_SESSION['name'])){
                    session_start();
                    if(isset($_SESSION['name']))
                    echo $_SESSION['name'];
    ...
    <!-- Icon Cards-->
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>New Messages!</h5></div>
            </div>
        ...
        <div class="mr-5"><h5>New Reviews!</h5></div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>New Bookings!</h5></div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card dashboard text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><h5>New Bookmarks!</h5></div>
            </div>
    ...
    <table class="table" border="1">
      ...
      <tbody>
        ...
        if(isset($_POST['search'])){
            $date = $_POST['date'];
            $booking = $con->query("SELECT * FROM booking WHERE dr_id='$u_id' AND date='$date'");
            $sl=1;
            ...
            <?php $sl++;}}
              ...
              <tr>
                <td class="text-center" colspan="6"><h6>No Data found</h6></td>
              </tr>

            <?php }
        }
        else{
        $booking = $con->query("SELECT * FROM booking WHERE dr_id='$u_id'");
        $sl=1;
        if($booking->num_rows>0){
        foreach ($booking as $key => $data) { 
        ?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="../../html_menu_1/logout.php">Logout</a>
          </div>
        </div>
      </div>
    </div>
