...
<body>
	...
	<main>
		...
		<?php
			...
			$id = $_GET['id'];
			$data = $con->query("SELECT * FROM doctor WHERE id='$id'");
			$doctor = $data->fetch_assoc();
			?>
			...
			<div class="row">
				<aside class="col-xl-3 col-lg-4" id="sidebar">
					<div class="box_profile">
						...
						<h1><?php if(isset($_GET['id'])) echo $doctor['name'] ?></h1>
						<span class="rating">
				...
				<div class="col-xl-9 col-lg-8">
					...
					<div class="box_general_2 add_bottom_45">
						...
						<ul class="treatments clearfix">
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit1" name="visit">
									<label for="visit1" class="css-label">Back Pain visit <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit2" name="visit">
									<label for="visit2" class="css-label">Cardiovascular screen <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit3" name="visit">
									<label for="visit3" class="css-label">Diabetes consultation <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit4" name="visit">
									<label for="visit4" class="css-label">Icontinence visit <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit5" name="visit">
									<label for="visit5" class="css-label">Foot Pain visit <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit6" name="visit">
									<label for="visit6" class="css-label">Food intollerance visit <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit7" name="visit">
									<label for="visit7" class="css-label">Neck Pain visit <strong>600 Tk</strong></label>
								</div>
							</li>
							<li>
								<div class="checkbox">
									<input type="checkbox" class="css-checkbox" value="600" id="visit8" name="visit">
									<label for="visit8" class="css-label">Back Pain visit <strong>600 Tk</strong></label>
								</div>
							</li>
						</ul>
						<hr>
						<div class="text-center"><button type="submit" class="btn_1 medium">Book Now</button></div>
					</div>
				</form>
					<!-- /box_general -->
					...
					<div class="tabs_styled_2">
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="general-tab" data-bs-toggle="tab" href="#general" role="tab" aria-controls="general" aria-expanded="true">General info</a>
							</li>
							<li class="nav-item">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
								...
								<hr>
								<div class="text-end"><a href="submit-review.php" class="btn_1 add_bottom_15">Submit review</a></div>
							</div>
							<!-- /tab_3 -->
						</div>
						<!-- /tab-content -->
